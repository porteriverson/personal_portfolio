...
const HomePage: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#141a1a] text-white font-sans p-4 pt-24 md:pt-24 lg:pt-32">
      ...
      <div className="max-w-6xl w-full">
        ...
        <header className="mb-12 md:mb-16 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16">
          ...
          <div className="md:w-1/2 text-center md:text-left animate-fade-in-up">
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto md:mx-0">
              I am a student at BYU getting a masters degree in Information
              Systems Management. I am fascinated by the potential of technology
            ...
            <ul className="mt-6 text-gray-400 text-lg md:text-xl space-y-2">
              ...
              <li className="transition-colors duration-300">
                ...
                that have defined my journey so far.
              </li>
            </ul>
          </div>
          ...
          <div className="md:w-1/2 flex justify-center animate-fade-in-down">
            <div className="relative w-full max-w-sm md:max-w-md rounded-md overflow-hidden transform transition-transform duration-500 hover:scale-105">
              <Image
        ...
        <main className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
          ...
          >
            <FolderOpen
              size={48}
              className="text-[#ed7b49] mb-4 transition-transform duration-300 group-hover:rotate-6"
            />
          ...
          >
            <FileText
              size={48}
              className="text-[#ed7b49] mb-4 transition-transform duration-300 group-hover:translate-y-1"
            />
          ...
          >
            <User
              size={48}
              className="text-[#ed7b49] mb-4 transition-transform duration-300 group-hover:scale-110"
            />
            <span className="text-xl font-bold">About Me</span>
            <p className="text-sm text-gray-400 mt-1">
              Read about my defining moments.
            </p>
          </a>
        </main>
      </div>
